 ...
 * generated in the me.xueyao.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _EmrService_QNAME = new QName("http://service.webservice.example.com", "emrService");
    private final static QName _EmrServiceResponse_QNAME = new QName("http://service.webservice.example.com", "emrServiceResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: me.xueyao.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.webservice.example.com", name = "emrService")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.webservice.example.com", name = "emrServiceResponse")
